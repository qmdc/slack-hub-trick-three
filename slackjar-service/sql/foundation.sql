create table slackjar_trick_three.sys_user
(
    ...
    create table slackjar_trick_three.role
(
...
create table slackjar_trick_three.user_role
(
...
create table slackjar_trick_three.permission
(
...
create table slackjar_trick_three.role_permission
(
    id            bigint auto_increment comment '关联记录ID'
        primary key,
    role_id       bigint            not null comment '角色ID（关联角色表主键）',
...
create table slackjar_trick_three.sys_file
(
...
create table slackjar_trick_three.ssl_certificate
(
...
create table slackjar_trick_three.sys_config
(
    id           bigint auto_increment comment '主键ID'
        primary key,
...
create table slackjar_trick_three.sys_dict
(
...
create table slackjar_trick_three.sys_dict_item
(
...
-- 用户设备登录记录表
create table slackjar_trick_three.user_device (
